...
def preprocess_data(input_path, output_train, output_test, test_size=0.2):
    ...
    try:
        ...
        logger.info("📊 Creating outputs for downstream components:")
        logger.info("   • Train data → TrainingStep component")
        logger.info("   • Test data → EvaluationStep component")
        ...
        raise ProcessingStep (ROOT NODE) ===")
    ...
    try:
        ...
        logger.error(f"❌ ROOT NODE FAILED: {str(e)}")
